  ...
  <div className="space-y-10">
    ...
    <div>
      ...
      <p className="text-slate-700 leading-relaxed">
        ...
        <a href="/rent-a-car-islamabad" className="text-blue-600 hover:underline"> car rental in Islamabad</a> 
        and 
        <a href="/rent-a-car-rawalpindi" className="text-blue-600 hover:underline"> car rental in Rawalpindi</a> 
