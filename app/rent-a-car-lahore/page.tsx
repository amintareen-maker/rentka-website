...
export default async function LahoreRentalPage() {
  ...
  return <>
    ...
    <main className="overflow-x-clip bg-white">
      ...
      <section className="px-4 py-14 sm:px-6 sm:py-18 lg:px-8"><div className="mx-auto grid max-w-7xl gap-7 rounded-[2rem] bg-[var(--rentka-blue)] p-8 text-white sm:p-10 md:grid-cols-[1fr_auto] md:items-center"><div><h2 className="text-3xl font-extrabold">Ready to Plan Your Lahore Rental?</h2><p className="mt-3 max-w-2xl leading-7 text-slate-200">Choose a current Lahore vehicle above, or review RentKA’s booking terms and support information before requesting availability.</p></div><nav aria-label="Lahore booking resources" className="flex flex-col gap-3 sm:flex-row md:flex-col"><a href="#lahore-cars" className="inline-flex min-h-12 items-center justify-center rounded-xl bg-[var(--rentka-green)] px-6 py-3 font-bold">Choose a Lahore car</a><Link href="/airport-car-rental-lahore" className="inline-flex min-h-12 items-center justify-center rounded-xl border border-white/30 px-6 py-3 font-bold">Lahore airport transfer</Link><Link href="/contact" className="inline-flex min-h-12 items-center justify-center rounded-xl border border-white/30 px-6 py-3 font-bold">Contact RentKA</Link><div className="flex justify-center gap-4 text-sm"><Link href="/terms" className="underline">Terms</Link><Link href="/cancellation-policy" className="underline">Cancellation policy</Link></div></nav></div></section>
